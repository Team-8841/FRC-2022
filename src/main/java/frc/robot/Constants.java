...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final double kDTRampRate          = 0.5; //Drivetrain open loop ramp rate | tune to slow acceleration (higher = slower)
        ...
        public static final double kStrightDriveP       = 0.1; //These PID values may not be needed
